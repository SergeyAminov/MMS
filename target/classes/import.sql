...
create table orders(id int primary key auto_increment, user int, address varchar(128), payment_method varchar(128), delivery_method varchar(128), payment_status varchar(128), delivery_status varchar(128), foreign key(user) references users(id) on delete set null);
...
create table order_items(id int primary key auto_increment, order_id int, title varchar(128), price double, count int, brand varchar(64), color varchar(64), weight double, diagonal double, storage double, ram int);
