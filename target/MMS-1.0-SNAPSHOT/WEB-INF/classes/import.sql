...
create table order_items(id int primary key auto_increment, title varchar(128), price double, count int, brand varchar(64), color varchar(64), weight double, diagonal double, storage double, ram int);
